...
export const stacksPractical = {
  en: {
    tag: "How to use stacks",
    title: "Ready-made bundles and simple rules",
    subtitle:
    ...
    playbooks: [
      {
        code: "B-01",
        title: "Business site",
        stack: "Astro + Cloudflare Pages + Markdown + GSC + Google Business Profile",
        useWhen: "You sell services, need contacts, and want fast SEO without app complexity.",
        steps: [
        ...
        avoid: ["Do not start with Next.js.", "Do not add a CMS if updates are rare."],
      },
      {
        code: "B-02",
        title: "Content site",
        stack: "Astro or Next.js + Markdown + GSC + GA4 or Plausible",
        useWhen: "You publish articles, guides or knowledge base pages.",
        steps: [
        ...
        avoid: ["Do not auto-publish AI text without review.", "Do not make many near-duplicate articles."],
      },
      {
        code: "B-03",
        title: "Store",
        stack: "Shopify + GA4 + GSC + ads later",
        useWhen: "You sell products, need shipping, and do not want to own checkout logic.",
        steps: [
        ...
        avoid: ["Do not build a custom cart on day one.", "Do not launch ads before checkout works."],
      },
      {
        code: "B-04",
        title: "Events and tickets",
        stack: "Next.js + Vercel + Supabase + Stripe + email delivery",
        useWhen: "You sell seats, tickets or limited access and need payment plus records.",
        steps: [
        ...
        avoid: ["Do not use Astro for paid ticketing.", "Do not rely on manual bank transfers for scale."],
      },
      {
        code: "B-05",
        title: "SaaS",
        stack: "Next.js + Vercel + Supabase + Stripe + auth",
        useWhen: "You need login, roles, subscriptions or dashboard state.",
        steps: [
        ...
        avoid: ["Do not start from a landing page only.", "Do not skip staging and billing tests."],
      },
      {
        code: "B-06",
        title: "Automation",
        stack: "n8n + forms + CRM or email + logging",
        useWhen: "You need repeatable lead routing, notifications or data sync.",
        steps: [
        ...
        avoid: ["Do not automate before the form works.", "Do not run flows without logs."],
      },
    ],
    rulesTitle: "Rules that save time",
    rules: [
    ...
    upgradeTitle: "When to upgrade the stack",
    upgrades: [
  ...
  pl: {
    tag: "Jak używać stacków",
    title: "Gotowe zestawy i proste zasady",
    subtitle:
      "Wybierz zestaw pod typ projektu, a potem sprawdź zasady zanim kupisz narzędzia albo zaczniesz kod.",
    playbooks: [
      {
        code: "B-01",
        title: "Strona usługowa",
        stack: "Astro + Cloudflare Pages + Markdown + GSC + Google Business Profile",
        useWhen: "Sprzedajesz usługi i chcesz szybkie SEO bez złożonej aplikacji.",
        steps: [
          "Napisz jedną ofertę i jedno główne CTA.",
          "Zbuduj 5 do 7 stron: start, usługi, o nas, kontakt, FAQ.",
          "Podłącz domenę, formularz, Search Console i mapę firmy.",
          "Dodaj opinie, godziny i prawdziwe zdjęcia.",
        ],
        avoid: ["Nie zaczynaj od Next.js.", "Nie dodawaj CMS, jeśli zmiany są rzadkie."],
      },
      {
        code: "B-02",
        title: "Content site",
        stack: "Astro lub Next.js + Markdown + GSC + GA4 albo Plausible",
        useWhen: "Publikujesz artykuły, poradniki lub bazę wiedzy.",
        steps: [
          "Zrób mapę tematów i stron filarowych.",
          "Ustal szablon artykułu i zasady linkowania.",
          "Dodaj sitemap, metadata i stronę autora.",
          "Odświeżaj słabe strony co miesiąc.",
        ],
        avoid: ["Nie publikuj AI tekstu bez review.", "Nie rób wielu niemal identycznych artykułów."],
      },
      {
        code: "B-03",
        title: "Sklep",
        stack: "Shopify + GA4 + GSC + reklamy później",
        useWhen: "Sprzedajesz produkty i nie chcesz sam utrzymywać checkoutu.",
        steps: [
          "Przygotuj produkty, ceny, zdjęcia i wysyłkę.",
          "Ustaw theme, kolekcje, podatki i strony prawne.",
          "Zrób realne testowe zamówienie i sprawdź maile.",
          "Dopiero potem podłącz feedy lub reklamy.",
        ],
        avoid: ["Nie buduj własnego koszyka na start.", "Nie odpalaj reklam przed działającym checkoutem."],
      },
      {
        code: "B-04",
        title: "Wydarzenia i bilety",
        stack: "Next.js + Vercel + Supabase + Stripe + email",
        useWhen: "Sprzedajesz miejsca, bilety lub limitowany dostęp.",
        steps: [
          "Najpierw określ poziomy biletów, limit i zwroty.",
          "Zbuduj checkout, webhooki i zapis biletów.",
          "Wyślij bilety QR i potwierdzenie mailowe.",
          "Dodaj widok check-in dla obsługi wydarzenia.",
        ],
        avoid: ["Nie używaj Astro do płatnych biletów.", "Nie opieraj procesu o ręczne przelewy."],
      },
      {
        code: "B-05",
        title: "SaaS",
        stack: "Next.js + Vercel + Supabase + Stripe + auth",
        useWhen: "Potrzebujesz logowania, ról, subskrypcji i stanu użytkownika.",
        steps: [
          "Opisz jeden workflow MVP i jeden model cenowy.",
          "Zdefiniuj role, tabele i dostęp do danych.",
          "Podłącz billing, portal klienta i sync webhooków.",
          "Dodaj onboarding, limity i kontakt do supportu.",
        ],
        avoid: ["Nie zaczynaj od samego landing page.", "Nie pomijaj staging i testów płatności."],
      },
      {
        code: "B-06",
        title: "Automatyzacja",
        stack: "n8n + formularze + CRM lub email + logi",
        useWhen: "Potrzebujesz powtarzalnego routingu leadów, alertów lub sync.",
        steps: [
          "Narysuj jeden flow na kartce: trigger, akcja, owner.",
          "Dodaj retry, logi i alert przy błędzie.",
          "Sprawdź duplikaty i limity API.",
          "Zapisz krótki runbook przekazania.",
        ],
        avoid: ["Nie automatyzuj zanim formularz działa.", "Nie uruchamiaj flow bez logów."],
      },
    ],
    rulesTitle: "Zasady, które oszczędzają czas",
    rules: [
      "Jeśli strona ma mniej niż 10 podstron i nie ma logowania, startuj od Astro.",
      "Użyj Next.js, gdy potrzebujesz logowania, dashboardów, płatności lub stanu użytkownika.",
      "Użyj Shopify, gdy główny cel to sprzedaż produktów, a nie budowa software.",
      "Dodaj Google Search Console zanim wydasz cokolwiek na reklamy.",
      "Najpierw jeden analytics, drugi dopiero gdy wiesz po co.",
      "Narzędzia Yandex dodawaj tylko wtedy, gdy odbiorcy faktycznie ich używają.",
      "Jeśli treści ma edytować osoba nietechniczna codziennie, nie zmuszaj jej do Git od razu.",
    ],
    upgradeTitle: "Kiedy robić upgrade stacku",
    upgrades: [
      "Astro → Next.js: pojawia się auth, dashboard, płatność lub stan użytkownika.",
      "Markdown → CMS: właściciel treści potrzebuje visual editor i publikuje często.",
      "Shopify → custom commerce: dopiero gdy logika biznesowa uzasadnia koszt dev.",
      "GA4 / Plausible → PostHog: potrzebujesz event funnel, product metrics lub session replay.",
      "Bez reklam → reklamy: dopiero gdy strona, formularz i tracking już działają.",
    ],
    launchTitle: "Przed launch",
    checklist: [
      "Właściciel umie opisać stronę jednym zdaniem.",
      "Domena, SSL, formularz i Search Console działają.",
      "Mobilka jest sprawdzona na prawdziwym telefonie.",
      "Jest 404, sitemap i robots.",
      "Po wejściu na stronę jest jasny następny krok.",
    ],
  },
  ru: {
    tag: "Как применять стеки",
    title: "Готовые наборы и простые правила",
    subtitle:
      "Сначала выбери тип проекта, потом инструменты. Так страница перестаёт быть списком модных слов и становится рабочей схемой.",
    playbooks: [
      {
        code: "B-01",
        title: "Сайт услуг",
        stack: "Astro + Cloudflare Pages + Markdown + GSC + Google Business Profile",
        useWhen: "Ты продаёшь услуги, нужны контакты и быстрый SEO-старт без сложного приложения.",
        steps: [
          "Сформулируй один оффер и одну кнопку действия.",
          "Собери 5–7 страниц: главная, услуги, о нас, контакты, FAQ.",
          "Подключи домен, форму, Search Console и карточку в картах.",
          "Добавь отзывы, часы работы и реальные фото.",
        ],
        avoid: ["Не начинай с Next.js.", "Не ставь CMS, если изменения редкие."],
      },
      {
        code: "B-02",
        title: "Контент-сайт",
        stack: "Astro или Next.js + Markdown + GSC + GA4 или Plausible",
        useWhen: "Публикуешь статьи, гайды или базу знаний.",
        steps: [
          "Сделай карту тем и страниц-столпов.",
          "Задай шаблон статьи и правила внутренних ссылок.",
          "Добавь sitemap, metadata и страницу автора.",
          "Раз в месяц обновляй слабые материалы.",
        ],
        avoid: ["Не публикуй AI-текст без ревью.", "Не делай много почти одинаковых статей."],
      },
      {
        code: "B-03",
        title: "Магазин",
        stack: "Shopify + GA4 + GSC + реклама позже",
        useWhen: "Продаёшь товары и не хочешь сам поддерживать checkout.",
        steps: [
          "Подготовь товары, цены, фото и доставку.",
          "Настрой тему, коллекции, налоги и юридические страницы.",
          "Сделай реальный тестовый заказ и проверь письма.",
          "Только потом подключай фиды или рекламу.",
        ],
        avoid: ["Не делай свою корзину на старте.", "Не запускай рекламу до рабочего checkout."],
      },
      {
        code: "B-04",
        title: "События и билеты",
        stack: "Next.js + Vercel + Supabase + Stripe + email",
        useWhen: "Ты продаёшь места, билеты или доступ с лимитом.",
        steps: [
          "Сначала определи типы билетов, лимит и возвраты.",
          "Собери checkout, webhook и хранение билетов.",
          "Отправляй билеты с QR и подтверждение по email.",
          "Добавь экран check-in для команды на входе.",
        ],
        avoid: ["Не используй Astro для платных билетов.", "Не опирайся на ручные переводы на старте."],
      },
      {
        code: "B-05",
        title: "SaaS",
        stack: "Next.js + Vercel + Supabase + Stripe + auth",
        useWhen: "Нужны логин, роли, подписки и состояние пользователя.",
        steps: [
          "Опиши один MVP workflow и одну модель цен.",
          "Определи роли, таблицы и доступ к данным.",
          "Подключи billing, portal клиента и sync webhook.",
          "Добавь onboarding, лимиты и контакт поддержки.",
        ],
        avoid: ["Не начинай с одного landing page.", "Не пропускай staging и тесты платежей."],
      },
      {
        code: "B-06",
        title: "Автоматизация",
        stack: "n8n + формы + CRM или email + логи",
        useWhen: "Нужны повторяемые маршруты лидов, уведомления или sync.",
        steps: [
          "Нарисуй один flow на бумаге: trigger, action, owner.",
          "Добавь retry, логи и alert при ошибке.",
          "Проверь дубли и лимиты API.",
          "Запиши короткий runbook передачи.",
        ],
        avoid: ["Не автоматизируй, пока форма не работает.", "Не запускай flow без логов."],
      },
    ],
    rulesTitle: "Правила, которые экономят время",
    rules: [
      "Если на сайте меньше 10 страниц и нет логина, начинай с Astro.",
      "Бери Next.js, когда нужны логин, дашборды, платежи или пользовательское состояние.",
      "Бери Shopify, когда главная задача — продавать товары, а не строить софт.",
      "Сначала подключи Google Search Console, потом уже рекламу.",
      "Сначала один analytics, второй только если понятно зачем.",
      "Инструменты Yandex добавляй только если аудитория реально ими пользуется.",
      "Если контент будет редактировать не технический человек каждый день, не заставляй его сразу жить в Git.",
    ],
    upgradeTitle: "Когда нужен upgrade стека",
    upgrades: [
      "Astro → Next.js: появляются auth, dashboard, платежи или user state.",
      "Markdown → CMS: владельцу контента нужен visual editor и он публикует часто.",
      "Shopify → custom commerce: только когда бизнес-логика оправдывает dev cost.",
      "GA4 / Plausible → PostHog: нужны event funnels, product metrics или session replay.",
      "Без рекламы → реклама: только после того, как страница, форма и tracking уже работают.",
    ],
    launchTitle: "Перед запуском",
    checklist: [
      "Владелец может объяснить сайт одной фразой.",
      "Домен, SSL, форма и Search Console работают.",
      "Мобильная версия проверена на реальном телефоне.",
      "Есть 404, sitemap и robots.",
      "После посещения страницы есть понятный следующий шаг.",
    ],
  },
  uk: {
    tag: "Як застосовувати stack",
    title: "Готові набори та прості правила",
    subtitle:
      "Спочатку обери тип проєкту, потім інструменти. Так page перестає бути списком слів і стає робочою схемою.",
    playbooks: [
      {
        code: "B-01",
        title: "Сайт послуг",
        stack: "Astro + Cloudflare Pages + Markdown + GSC + Google Business Profile",
        useWhen: "Ти продаєш послуги, потрібні контакти та швидкий SEO-старт без складного app.",
        steps: [
          "Сформулюй один офер і одну кнопку дії.",
          "Збери 5–7 сторінок: головна, послуги, про нас, контакти, FAQ.",
          "Підключи домен, форму, Search Console і картку в мапах.",
          "Додай відгуки, години роботи та реальні фото.",
        ],
        avoid: ["Не починай з Next.js.", "Не став CMS, якщо зміни рідкі."],
      },
      {
        code: "B-02",
        title: "Content site",
        stack: "Astro або Next.js + Markdown + GSC + GA4 або Plausible",
        useWhen: "Публікуєш статті, гайди або knowledge base.",
        steps: [
          "Зроби карту тем і сторінок-стовпів.",
          "Задай шаблон статті та правила внутрішніх лінків.",
          "Додай sitemap, metadata і сторінку автора.",
          "Раз на місяць оновлюй слабкі матеріали.",
        ],
        avoid: ["Не публікуй AI-текст без review.", "Не роби багато майже однакових статей."],
      },
      {
        code: "B-03",
        title: "Магазин",
        stack: "Shopify + GA4 + GSC + реклама пізніше",
        useWhen: "Продаєш товари і не хочеш підтримувати checkout сам.",
        steps: [
          "Підготуй товари, ціни, фото і доставку.",
          "Налаштуй theme, колекції, податки та legal pages.",
          "Зроби реальне тестове замовлення і перевір листи.",
          "Лише потім підключай фіди або рекламу.",
        ],
        avoid: ["Не роби свій кошик на старті.", "Не запускай рекламу до робочого checkout."],
      },
      {
        code: "B-04",
        title: "Події та квитки",
        stack: "Next.js + Vercel + Supabase + Stripe + email",
        useWhen: "Ти продаєш місця, квитки або доступ з лімітом.",
        steps: [
          "Спочатку визнач типи квитків, ліміт і повернення.",
          "Збери checkout, webhook і збереження квитків.",
          "Надсилай квитки з QR та підтвердження email.",
          "Додай екран check-in для команди на вході.",
        ],
        avoid: ["Не використовуй Astro для paid ticketing.", "Не спирайся на ручні перекази на старті."],
      },
      {
        code: "B-05",
        title: "SaaS",
        stack: "Next.js + Vercel + Supabase + Stripe + auth",
        useWhen: "Потрібні login, ролі, підписки і стан користувача.",
        steps: [
          "Опиши один MVP workflow і одну модель цін.",
          "Визнач ролі, таблиці та доступ до даних.",
          "Підключи billing, portal клієнта і sync webhook.",
          "Додай onboarding, ліміти і контакт підтримки.",
        ],
        avoid: ["Не починай з одного landing page.", "Не пропускай staging і тести платежів."],
      },
      {
        code: "B-06",
        title: "Автоматизація",
        stack: "n8n + форми + CRM або email + логи",
        useWhen: "Потрібні повторювані маршрути лідів, сповіщення або sync.",
        steps: [
          "Намалюй один flow на папері: trigger, action, owner.",
          "Додай retry, логи та alert при помилці.",
          "Перевір дублікати й ліміти API.",
          "Запиши короткий runbook передачі.",
        ],
        avoid: ["Не автоматизуй, поки форма не працює.", "Не запускай flow без логів."],
      },
    ],
    rulesTitle: "Правила, що економлять час",
    rules: [
      "Якщо на сайті менше 10 сторінок і немає логіну, стартуй з Astro.",
      "Бери Next.js, коли потрібні login, dashboard, платежі або user state.",
      "Бери Shopify, коли головна задача — продавати товари, а не будувати software.",
      "Спочатку підключи Google Search Console, потім уже рекламу.",
      "Спершу один analytics, другий тільки якщо зрозуміло навіщо.",
      "Інструменти Yandex додавай лише якщо аудиторія реально ними користується.",
      "Якщо контент буде редагувати нетехнічна людина щодня, не змушуй її одразу жити в Git.",
    ],
    upgradeTitle: "Коли потрібен upgrade stack",
    upgrades: [
      "Astro → Next.js: зʼявляються auth, dashboard, платежі або user state.",
      "Markdown → CMS: власнику контенту потрібен visual editor і він публікує часто.",
      "Shopify → custom commerce: лише коли business logic виправдовує dev cost.",
      "GA4 / Plausible → PostHog: потрібні event funnels, product metrics або session replay.",
      "Без реклами → реклама: тільки після того, як сторінка, форма і tracking уже працюють.",
    ],
    launchTitle: "Перед запуском",
    checklist: [
      "Власник може пояснити сайт одним реченням.",
      "Домен, SSL, форма і Search Console працюють.",
      "Мобільна версія перевірена на реальному телефоні.",
      "Є 404, sitemap і robots.",
      "Після відвідування сторінки є зрозумілий наступний крок.",
    ],
  },
} as const;
...
export const briefPage = {
  ...
  ru: {
    tag: "Конструктор брифа",
    title: "Как составить бриф на сайт для малого бизнеса?",
    subtitle: "Полезный бриф фиксирует бизнес-цель, аудиторию, оффер, главное действие, список страниц, готовый контент, интеграции, диапазон бюджета, срок и ответственного за решение. Эти данные помогают быстро оценить объём и предложить подходящий формат разработки.",
    submit: "Получить рекомендацию",
    resultTitle: "Твоя рекомендация",
    seo: {
      label: "Практический бриф",
      intro: "Пишите бриф обычным деловым языком. Одно или два конкретных предложения на каждый пункт создают достаточный контекст для первого предложения. Добавляйте ссылки, примеры и реальные цифры. Первая версия спокойно помещается на одной странице и получает детали после выбора формата внедрения.",
      sections: [
      ...
      builderTitle: "Как собрать первую версию брифа?",
...
export const guidesPipelineUpdate = {
  en: {
    ...
    whereBreaks: "Common implementation issues",
  ...
  pl: {
    ...
    whereBreaks: "Najczęstsze problemy wdrożenia",
  ...
  ru: {
    ...
    whereBreaks: "Частые проблемы внедрения",
  ...
  uk: {
    ...
    whereBreaks: "Поширені проблеми впровадження",
