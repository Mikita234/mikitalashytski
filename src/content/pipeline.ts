...
export const guidesPipelineUpdate = {
  en: {
    ...
    comingTag: "Guide tape",
    comingTitle: "Extra practical tapes",
  ...
  pl: {
    ...
    comingTag: "Taśma poradnika",
    comingTitle: "Dodatkowe praktyczne taśmy",
  ...
  ru: {
    ...
    comingTag: "Гайд-кассета",
    comingTitle: "Дополнительные практические кассеты",
  ...
  uk: {
    ...
    comingTag: "Гайд-касета",
    comingTitle: "Додаткові практичні касети",
    personasTag: "Для кого",
