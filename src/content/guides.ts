...
export const guideLabels = {
  en: {
    all: "All guides",
    outcome: "Result of the guide",
    steps: "Instructions",
    mistakes: "Check before publishing",
    next: "Next guide",
    read: "Read guide",
    minutes: "min read",
    back: "Back to guides",
  ...
  pl: {
    ...
    outcome: "Rezultat poradnika",
    steps: "Instrukcja",
    mistakes: "Sprawdź przed publikacją",
    next: "Następny poradnik",
  ...
  ru: {
    all: "Все гайды",
    outcome: "Результат после выполнения",
    steps: "Инструкция",
    mistakes: "Проверка перед публикацией",
    next: "Следующий гайд",
    read: "Открыть гайд",
    minutes: "мин чтения",
    back: "Назад к гайдам",
  ...
  uk: {
    all: "Усі гайди",
    outcome: "Результат після виконання",
    steps: "Інструкція",
    mistakes: "Перевірка перед публікацією",
    next: "Наступний гайд",
    read: "Відкрити гайд",
    minutes: "хв читання",
...
export const guides: Guide[] = [
  {
    ...
    description: {
      ...
      pl: "Praktyczny proces uruchomienia strony: praca z AI, GitHub, Vercel, domena, formularz i podstawy SEO.",
      ru: "Практический путь от идеи до живого сайта: AI-assisted coding, GitHub, Vercel, домен, форма и базовое SEO.",
      uk: "Практичний процес запуску сайту: робота з AI, GitHub, Vercel, домен, форма та базове SEO.",
    },
    intro: {
