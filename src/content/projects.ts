...
export const projects: Project[] = [
  {
    slug: "kayer",
    name: "KAYER",
    domains: ["kayer.pl", "kayer.ua"],
    links: [
      { label: "kayer.pl", href: "https://kayer.pl" },
      { label: "kayer.ua", href: "https://kayer.ua" },
    ],
    accent: "violet",
    year: "2024 — now",
    stack: [
    ...
    metrics: [
      { key: "markets", value: "2", source: "ops" },
      { key: "langs", value: "3", source: "ops" },
      { key: "integrations", value: "7+", source: "ops" },
      { key: "skus", value: "300+", source: "ops", isPlaceholder: true },
      { key: "pages", value: "400+", source: "ops", isPlaceholder: true },
  ...
  },
  {
    ...
    metrics: [
      { key: "reports", value: "ABC/XYZ", source: "ops" },
      { key: "ai", value: "recs", source: "ops" },
      { key: "export", value: "XLSX", source: "ops" },
      { key: "forecast", value: "yes", source: "ops" },
    ],
    lists: ["role", "ops", "integrations", "seo", "ai"],
    hasLivePreview: false,
    screenshots: [
      "/cases/baselinker-reports/dashboard.webp",
      "/cases/baselinker-reports/abc-xyz.webp",
    ],
  },
  {
    slug: "lead-scraping",
