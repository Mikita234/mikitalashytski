...
export const pipelines: ProjectPipeline[] = [
  ...
  },
  {
    ...
    requiredInputs: LA(
      ["Content plan (10 topics)", "Author bio", "Category structure"],
      ["Plan contentu (10 tematów)", "Bio autora", "Struktura kategorii"],
      ["Контент-план (10 тем)", "Bio автора", "Структура категорий"],
      ["Контент-план (10 тем)", "Bio автора", "Структура категорій"],
    ),
    recommendedStack: ["astro", "cloudflare-pages", "markdown"],
    alternatives: ["nextjs", "vercel"],
    rejectedOptions: LA(
