...
import { IBM_Plex_Mono, Manrope, Press_Start_2P, Roboto_Condensed } from "next/font/google";
...
export default async function LocaleLayout({
  ...
  return (
    <html
      ...
      className={`${manrope.variable} ${ibmMono.variable} ${robotoCondensed.variable} ${pressStart.variable}`}
    >
